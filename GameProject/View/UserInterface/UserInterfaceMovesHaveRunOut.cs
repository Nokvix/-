...
public class UserInterfaceMovesHaveRunOut
{
    public static Background CreateBackground(ContentManager content)
    {
        var background = new Background(new SpriteRectangle(content.Load<Texture2D>("Закончились ходы"), //Подведение итогов (1).png
    ...
    public static Inscription CreateInscriptionWinner(ContentManager content)
    {
        ...
        var sprite = new SpriteVector(yellow, new Vector2(617, 392));
